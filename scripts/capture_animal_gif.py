#!/usr/bin/env python3
"""
Capture the animal-v2 stacked preview (back + character + front) as a 90-frame
...
GIF_PATH = OUT / "animal-v2-preview.gif"

URL = "http://127.0.0.1:8765/preview-animal-v2.html"
TOTAL_FRAMES = 90
FPS = 30
