"""Build flower back.json + front.json Lottie. Embeds webps as data URIs."""
import base64
import json
import math
...
# BACK layers — front-to-back order in array (index 1 = top of stack)
BACK = [
    ("vines", ROOT / "assets/flower/back-opt/vines.webp", m_bob_x(10)),
    ("trees", ROOT / "assets/flower/back-opt/trees.webp", m_pan_y_breathe(20, 3)),
    ("hills", ROOT / "assets/flower/back-opt/hills.webp", m_pan_y_breathe(15, 2)),
    ("sky",   ROOT / "assets/flower/back-opt/sky.webp",   m_breathe(5)),
]

# FRONT layers — front-to-back order in array
FRONT = [
    ("particles",  ROOT / "assets/flower/front-opt/particles.webp",  m_figure8(40, 60)),
    ("flowers",    ROOT / "assets/flower/front-opt/flowers.webp",    m_bob_y(15)),
    ("big-leaves", ROOT / "assets/flower/front-opt/big-leaves.webp", m_bob_y(6)),
    # grass.png source has ~130px padding below grass strip; y_offset +95 lands strip at canvas bottom (covers pan_y ±8 motion)
    ("grass",      ROOT / "assets/flower/front-opt/grass.webp",      {**m_pan_y(8), "y_offset": 95}),
]


if __name__ == "__main__":
    build_lottie(BACK,  ROOT / "assets/flower/back.json")
    build_lottie(FRONT, ROOT / "assets/flower/front.json")
